...
public class CanteenAdminView extends JFrame {
	...
	final ImageIcon backgroundLeft = new ImageIcon(this.getClass().getResource("/image/食堂管理1.png"));
	
	
	
	public CanteenAdminView(User us){ //构造器
		user = us;
		...
		jt.setBounds(35, 20, 145, 120);//调整左侧树的位置
	...
	private void addTreelistener(final CanteenAdminView canteenAdminView) { //为树添加选择模型的监听器
	...
	private void initJp() {
		...
		jp.add(new CaDishSearch(this.user),"ds");//相应对象待添加
