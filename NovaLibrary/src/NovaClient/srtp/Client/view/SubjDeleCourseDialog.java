 ...
 *
 */
public class SubjDeleCourseDialog extends JDialog implements ActionListener,
MessageType {
	...
	// 构造函数
	public SubjDeleCourseDialog(/*Frame arg0, String arg1, boolean arg2*/) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==jb1){
			 ...
			 String sql;
			 sql="delete  from SubjInfo where 课程编号='"+jtf1.getText()+"'";
			 ISubjseleImpl.delSubj(sql);
  ...
  //  SubjDeleCourseDialog f1=new SubjDeleCourseDialog();}
}